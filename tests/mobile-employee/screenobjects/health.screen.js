...
const SELECTORS = {
  ...
  UPDATE_HEALTH_DATA_BUTTON: '~Update my lifestyle data',
  HEALTH_FIGURE_IOS:
  ...
  LAST_BAR_HISTORY_GRAPH_IOS:
    '(//XCUIElementTypeOther[@name="Health Score History Graph showing last 6 records."])[3]/XCUIElementTypeOther[2]/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther[14]',
  AGING_SLIDER_IOS:
